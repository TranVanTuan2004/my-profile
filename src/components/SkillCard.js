...
import { SiVisualstudiocode, SiReact, SiReactrouter, SiBootstrap, SiFigma, SiInkscape, SiLaravel, SiComposer } from "react-icons/si";
import { TbBrandCss3, TbBrandJavascript, TbBrandHtml5, TbBrandPhp } from "react-icons/tb";
      ...
      <div className="skill-container" id={id}>
        ...
        <div className="skill-box">
          ...
          <div className="skillset">
            ...
            <abbr title='JavaScript'><TbBrandPhp className='techLogo' /></abbr>
          </div>
        </div>
        <div className="skill-box">
          ...
          <div className="skillset">
            ...
            <abbr title='ReactJS'><SiLaravel className='techLogo' /></abbr>
